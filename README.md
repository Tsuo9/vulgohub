...
while wait() do
    for i,v in pairs(game:GetService("Workspace")["_WorldOrigin"]:GetChildren()) do
        pcall(function()
            if v.Name == ("CurvedRing") or v.Name == ("AndreshHit") or v.Name == ("SwordAndresh") or v.Name == ("AndreshTail") or v.Name == ("Sounds") then
                v:Destroy()
            end
        end)
    end
...
local Window = OrionLib:MakeWindow({Name = "Andre Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Andre Hub"})
